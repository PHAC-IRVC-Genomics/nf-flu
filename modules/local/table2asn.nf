...
process TABLE2ASN {
  ...
  container "${ workflow.containerEngine == 'singularity' && !params.singularity_pull_docker_container ? 'https://depot.galaxyproject.org/singularity/table2asn:1.28.943--h48fe88c_0' : 'quay.io/biocontainers/table2asn:1.28.943--h48fe88c_0' }"
...
process POST_TABLE2ASN {
  ...
  container "${ workflow.containerEngine == 'singularity' && !params.singularity_pull_docker_container ? 'https://depot.galaxyproject.org/singularity/gfflu:0.0.2--pyhdfd78af_0' : 'quay.io/biocontainers/gfflu:0.0.2--pyhdfd78af_0' }"
