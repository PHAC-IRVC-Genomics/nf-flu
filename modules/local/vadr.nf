process SETUP_FLU_VADR_MODEL {
  ...
  container "${ workflow.containerEngine == 'singularity' && !params.singularity_pull_docker_container ? 'staphb/vadr:1.6.3-hav-flu2' : 'quay.io/biocontainers/vadr:1.6.4--pl5321h031d066_0' }"
